...
// VERSION
//
void CC_Version::MakeFrame(APIFrame& frame, const ccid_t cmdid, const ccparams_t& params)
{
	(void)cmdid;
...
void CC_Version::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
...
//
void CC_ManufacturerSpecific::MakeFrame(APIFrame& frame, const ccid_t , const ccparams_t& params)
{
...
void CC_ManufacturerSpecific::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
...
// BATTERY
//
void CC_Battery::MakeFrame(APIFrame& frame, const ccid_t cmdid, const ccparams_t& params)
{
	(void)params;
	(void)cmdid;
...
void CC_Battery::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
...
// SWITCH BINARY
//
void CC_SwitchBinary::MakeFrame(APIFrame& frame, ccid_t cmdid, const ccparams_t& params)
{
	switch (cmdid.value)
	{
...
void CC_SwitchBinary::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
...
// BASIC (0x20)
//
void CC_Basic::MakeFrame(APIFrame& frame, ccid_t cmdid, const ccparams_t& params)
{
	switch (cmdid.value)
	{
...
void CC_Basic::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	const uint8_t cmdId = cmdid.value;
...
//
void CC_SwitchMultilevel::MakeFrame(APIFrame& frame, ccid_t cmdid, const ccparams_t& params)
{
	(void)params;
	(void)cmdid;
...
void CC_SwitchMultilevel::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
...
// SENSOR BINARY (0x30)
//
void CC_SensorBinary::MakeFrame(APIFrame& frame, ccid_t cmdid, const ccparams_t& params)
{
	(void)params;
	(void)cmdid;
...
void CC_SensorBinary::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
...
// METER (0x32 / 0x50)
//
void CC_Meter::MakeFrame(APIFrame& frame, ccid_t cmdid, const ccparams_t& params)
{
	(void)params;
	(void)cmdid;
...
void CC_Meter::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
...
// MULTI CHANNEL (0x60)
//
void CC_MultiChannel::MakeFrame(APIFrame& frame, ccid_t cmdid, const ccparams_t& params)
{
	const uint8_t cmdId = cmdid.value;
	switch (cmdId)
	{
...
void CC_MultiChannel::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
...
//		ccparams_t payload(params.begin() + 3, params.end());

//		node.HandleCCDeviceReport(commandClass, command, payload); / TODO
	}
	break;
	//
...
// CONFIGURATION (0x70)
//
void CC_Configuration::MakeFrame(APIFrame& frame, ccid_t cmdid, const ccparams_t& params)
{
...
void CC_Configuration::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
...
// PROTECTION (0x75)
//
void CC_Protection::MakeFrame(APIFrame& frame, ccid_t cmdid, const ccparams_t& params)
{
	(void)params;
	(void)cmdid;
...
void CC_Protection::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
...
// ASSOCIATION (0x85)
//
void CC_Association::MakeFrame(APIFrame& frame, const ccid_t cmdid, const ccparams_t& params)
{
	const uint8_t cmdId = cmdid.value;
...
void CC_Association::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
	switch (cmdId)
...
//
void CC_MultiChannelAssociation::MakeFrame(APIFrame& frame, ccid_t cmdid, const ccparams_t& params)
{
	const uint8_t cmdId = cmdid.value;
...
void CC_MultiChannelAssociation::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
...
// WAKE UP
//
void CC_WakeUp::MakeFrame(APIFrame& frame, ccid_t cmdid, const ccparams_t& params)
{
	const uint8_t cmdId = cmdid.value;
...
// HANDLE REPORT
//
void CC_WakeUp::HandleReport(const ccid_t cmdid, const uint8_t destinationEP, const ccparams_t& params)
{
	(void)destinationEP;
	const uint8_t cmdId = cmdid.value;
	auto* cc = node.GetCC(eCommandClass::WAKE_UP);
